...
- **用例来源**：`docs/测试用例.md`（功能用例编号与步骤；可选在 describe/test 名称中标注测试用例编号以便追溯）
...
- 建议在 `test.describe` 或 test 名称中标注 [docs/测试用例.md](../docs/测试用例.md) 编号，便于与测试用例文档对应，例如「业务端 - 公寓管理（对应测试用例 3.1、3.2）」、test 名末尾「（APT-C-01）」。
...
更多细节与示例见 [docs/e2e-writing-guide.md](../docs/e2e-writing-guide.md)。
