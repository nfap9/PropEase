  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-end">
          <Button onClick={() => navigate('/workspace/subscription/purchase')} data-testid={SUBSCRIPTION.UPGRADE_BUTTON} icon={<ShoppingCart className="h-4 w-4" />}>
        ...
        {isLoading ? (
          ...
          <>
            {/* 当前订阅卡片 */}
            <Card
              data-testid={SUBSCRIPTION.CURRENT_SUBSCRIPTION}
              title={
            ...
            >
              {subscriptionStatus?.has_subscription && subscriptionStatus.service ? (
                ...
                <div className="flex flex-col items-center justify-center gap-4 py-4">
                  ...
                  <Button onClick={() => navigate('/workspace/subscription/purchase')} icon={<ShoppingCart className="h-4 w-4" />}>
                    {tenantMessages.settings.subscriptionPage.buyService}
                  </Button>
                </div>
              )}
            ...
            {/* 配额使用卡片 */}
            <Card
              data-testid={SUBSCRIPTION.USAGE_CARD}
              title={
                <span className="flex items-center gap-2">
