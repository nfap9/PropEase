  ...
  return (
    <>
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="flex flex-col items-center rounded-lg bg-green-50 p-2 dark:bg-green-950/30 dark:data-[state=active]:bg-green-900/30">
          <Home className="mb-1 h-4 w-4 text-green-600 dark:text-green-500" />
          <span className="text-lg font-semibold text-green-600 dark:text-green-500">{stats.available}</span>
        ...
        <div className="flex flex-col items-center rounded-lg bg-blue-50 p-2 dark:bg-blue-950/30">
          <Users className="mb-1 h-4 w-4 text-blue-600 dark:text-blue-500" />
          <span className="text-lg font-semibold text-blue-600 dark:text-blue-500">{stats.occupied}</span>
          <span className="text-xs text-muted-foreground">已租</span>
        </div>
      </div>
      {stats.maintenance > 0 && (
        <div className="mt-3 flex items-center gap-2 text-sm text-orange-600 dark:text-orange-500">
