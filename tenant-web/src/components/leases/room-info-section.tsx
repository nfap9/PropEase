      ...
      {isRoomSpecified && room ? (
        <div className="rounded-2xl border border-border/60 bg-muted/20 p-5">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-card shadow-sm border border-border">
          ...
          <div className="mt-4 grid grid-cols-3 gap-4">
            <div className="rounded-xl bg-card px-4 py-3 text-center shadow-sm border border-border">
