...
function parseBrand(brand: unknown): BrandConfig {
  ...
  return {
    ...
    app_description: typeof b.app_description === 'string' ? b.app_description : DEFAULT_BRAND.app_description,
    ...
    login_subtitle: typeof b.login_subtitle === 'string' ? b.login_subtitle : DEFAULT_BRAND.login_subtitle,
    register_subtitle: typeof b.register_subtitle === 'string' ? b.register_subtitle : DEFAULT_BRAND.register_subtitle,
  };
}
