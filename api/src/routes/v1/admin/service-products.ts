...
const ServiceProductCreateSchema = z.object({
  ...
  max_organizations: z.number().int().optional().nullable(),
  max_apartments: z.number().int().default(1),
  max_rooms: z.number().int().default(100),
  max_members: z.number().int().default(1),
...
const ServiceProductUpdateSchema = z.object({
  ...
  max_organizations: z.number().int().optional().nullable(),
  max_apartments: z.number().int().optional(),
  max_rooms: z.number().int().optional(),
