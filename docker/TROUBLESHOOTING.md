...
# 2. 查看 API 日志
docker compose -f docker/docker-compose.prod.yaml --env-file .env.production logs api --tail 50
```
...
# 2. 重启 API
docker compose -f docker/docker-compose.prod.yaml --env-file .env.production up -d --force-recreate api
