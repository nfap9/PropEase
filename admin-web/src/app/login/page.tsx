...
export default function AdminLoginPage() {
  ...
  return (
    <div
      className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(37,99,235,0.20),_transparent_26%),linear-gradient(135deg,_#eff6ff_0%,_#f8fafc_46%,_#e0ecff_100%)] dark:bg-background dark:bg-none"
            ...
            <Card className="w-full max-w-xl rounded-[32px] border-border/60 bg-card/70 shadow-2xl backdrop-blur-2xl dark:bg-card/50">
              <CardHeader className="space-y-6 pb-6">
                <div className="inline-flex w-fit rounded-full border border-border/70 bg-muted/70 p-1">
                  <div className="rounded-full bg-background px-4 py-2 text-sm font-medium text-foreground shadow-sm">
                    {adminMessages.login.entryBadge}
                  </div>
                </div>
                <div className="space-y-2">
                  <CardTitle className="text-2xl font-semibold text-foreground sm:text-[1.85rem]">{adminMessages.login.formTitle}</CardTitle>
                  <CardDescription className="max-w-lg text-sm leading-7 text-muted-foreground">
