...
def create_admin_access_token(admin_user_id: str, expires_delta: timedelta | None = None) -> str:
    """生成运营后台访问令牌，payload.type 为 'admin'，sub 为 admin_user_id。"""
    to_encode = {"sub": admin_user_id, "type": "admin"}
    if expires_delta:
        expire = datetime.now(UTC) + expires_delta
    else:
